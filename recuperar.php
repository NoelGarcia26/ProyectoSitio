...
<head>
    ...
    <title>Restaurar Contraseña - EclipseForge</title>
...
<body>
 ...
 <div class="container d-flex justify-content-center align-items-center min-vh-100 mt-5">
        <div class="recover-form p-5 rounded shadow-lg">
            ...
            <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($email) || empty($password) || empty($confirmPassword)) {
                        ...
                        echo "<p class='text-success text-center'>Contraseña cambiada exitosamente.</p>";
                    }
                }
            ?>
