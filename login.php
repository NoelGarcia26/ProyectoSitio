...
<body>
 ...
 <div class="container d-flex justify-content-center align-items-center min-vh-100 mt-5">
        <div class="login-form p-5 rounded shadow-lg">
            ...
            <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    // Validación simple para ilustración
                    if ($email == "usuario@example.com" && $password == "1234") {
                        echo "<p class='text-success text-center'>Inicio de sesión exitoso.</p>";
                    } else {
                        echo "<p class='text-danger text-center'>Email o contraseña incorrectos.</p>";
                    }
                }
            ?>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <a href="recuperar.php" class="link-secondary text-decoration-none">¿Olvidaste tu contraseña?</a>
                <span>¿No tienes cuenta? <a href="registro.php" class="link-primary text-decoration-none">Regístrate</a></span>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="padding-left: 100px;">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="text-white">Registrate</a></li>
